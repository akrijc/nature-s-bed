    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Tuto stránku se nepodařilo najít – možná byla přesunuta.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Záhonky od Danušky – dřevěné vyvýšené záhony" },
      {
        name: "description",
        content:
          "Dřevěné vyvýšené záhony ze severské borovice a modřínu. Hotové rozměry i záhony na míru.",
      },
